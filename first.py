...
def add_blur_and_noise(image: np.array, sigma, kernlen, standard_deviation):
  K = psf_fft(gaussian_kernel(kernlen, sigma), kernlen, image.shape)
...
def first(image: np.array, sigma, kernlen, standard_deviation):
  corrupted_image = add_blur_and_noise(image, sigma, kernlen, standard_deviation)
